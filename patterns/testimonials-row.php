 ...
 * Description: Three student testimonial cards with avatar, stars, and quoted review.
 */
?>
<!-- wp:html -->
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <blockquote class="bg-white rounded-xl p-8 flex flex-col gap-4" style="border:1px solid rgba(196,198,208,0.2);box-shadow:0 8px 32px rgba(26,60,110,0.04);">
        ...
        <div class="flex gap-0.5">
          <svg class="w-3 h-3" fill="#fdaf2e" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
          <svg class="w-3 h-3" fill="#fdaf2e" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
          <svg class="w-3 h-3" fill="#fdaf2e" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
          <svg class="w-3 h-3" fill="#fdaf2e" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
          <svg class="w-3 h-3" fill="#fdaf2e" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/></svg>
        </div>
        <p class="text-[15px] leading-relaxed italic pl-3" style="color:#43474f;border-left:3px solid #fdaf2e;">"The curriculum was incredibly thorough. Within three months of completing the Strategic Management course, I secured a promotion to Senior level. Truly a career-changing platform."</p>
      </blockquote>
      ...
      <blockquote class="bg-white rounded-xl p-8 flex flex-col gap-4" style="border:1px solid rgba(196,198,208,0.2);box-shadow:0 8px 32px rgba(26,60,110,0.04);">
        ...
        <p class="text-[15px] leading-relaxed italic pl-3" style="color:#43474f;border-left:3px solid #fdaf2e;">"As a busy professional, I needed flexibility without sacrificing quality. StudyMate Central provided both. The accreditation is respected everywhere in the UK market."</p>
      </blockquote>
      ...
      <blockquote class="bg-white rounded-xl p-8 flex flex-col gap-4 sm:col-span-2 lg:col-span-1" style="border:1px solid rgba(196,198,208,0.2);box-shadow:0 8px 32px rgba(26,60,110,0.04);">
        ...
        <p class="text-[15px] leading-relaxed italic pl-3" style="color:#43474f;border-left:3px solid #fdaf2e;">"The quality of the instructors is what sets this platform apart. They aren't just academics — they are industry veterans sharing real-world insights that are immediately applicable."</p>
      </blockquote>
